 ...
 */
fun accountInThreeYears(initial: Int, percent: Int): Double = ((initial*(percent*0.01)+initial)*(percent*0.01)+(initial*(percent*0.01)+initial))*(percent*0.01)+((initial*(percent*0.01)+initial)*(percent*0.01)+(initial*(percent*0.01)+initial))
/**
 * Простая
 *
